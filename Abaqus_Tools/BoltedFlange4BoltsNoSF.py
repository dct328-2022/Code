...
# ================================== Input File ===========================================
#InpFile = "/media/chenting/OS/Temp/BoltedFlange4BoltsNoSFo.inp"
#NewInpFile = "/media/chenting/OS/Temp/BoltedFlange4BoltsNoSF.inp"

InpFile = "/home/chenting/Documents/BoltedFlange4BoltsSF2o.inp"
NewInpFile = "/home/chenting/Documents/BoltedFlange4BoltsSF2.inp"
    ...
    if line.startswith("*End Assembly"):
        ...
        for i, obji in enumerate(SteelPlate1NodeSet):
            for j, objj in enumerate(SteelPlate2NodeSet):
                if abs(obji[1] - objj[1]) < 0.1 and abs(obji[2] - objj[2]) < 0.1 and 5.8 < obji[3] - objj[3] < 6.1 and (obji[1] - 25)**2 + (obji[2] - 25)**2 > 6.1**2:
                    PairCounter += 1
