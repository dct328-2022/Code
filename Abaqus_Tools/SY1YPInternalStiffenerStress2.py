...
# for 120kN
#Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY1ISSYP1.txt'
#Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY1ISSYP2.txt'

# for 90kN
#Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY1ISSYP3.txt'
#Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY1ISSYP4.txt'

# for 60kN
#Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY1ISSYP5.txt'
Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY1ISSYP6.txt'
...
filepath = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/TplllYP.txt'
f1 = open(filepath)
linecounter = 0
stressnodelist = [[], []]
for line in f1:
