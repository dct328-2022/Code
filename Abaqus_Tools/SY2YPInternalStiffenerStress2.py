...
# for 120kN
#Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY2ISSYP1.txt'
#Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY2ISSYP2.txt'

# for 90kN
#Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY2ISSYP3.txt'
#Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY2ISSYP4.txt'

# for 60kN
#Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY2ISSYP5.txt'
Outfile = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/SY2ISSYP6.txt'
...
filepath = '/media/chenting/Work/ProgramCode/AbaqusInpScript2/TplllYPY2.txt'
f1 = open(filepath)
linecounter = 0
stressnodelist = [[], []]
for line in f1:
