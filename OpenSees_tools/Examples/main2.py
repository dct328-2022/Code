...
NDMaterial.DruckerPrager(108, 170833.3333, 78846.15385, 345, 0, 0, 1, 1, 0, 0, 1708.3333, 1, 0)
...
ShellElement.ShellNLDKGTMeshed(5, 8, 4, 1, 6, 100, 10001, 10001, 10008)
ShellElement.ShellNLDKGTMeshed(6, 7, 3, 2, 6, 100, 20001, 20001, 10008)
ShellElement.ShellNLDKGTMeshed(5, 1, 2, 6, 100, 6, 30001, 30001, 10008)
ShellElement.ShellNLDKGTMeshed(8, 4, 3, 7, 100, 6, 40001, 40001, 10008)
...
LinearSeries = TimeSeries.Linear(1, 100.0)
EmptySeries1 = TimeSeries.Empty(2)
EmptySeries2 = TimeSeries.Empty(3)
Recorder.NodeRecorder([0, 1, 2, 3, 4, 5], [10], "disp", "Node10.out")
Recorder.NodeRecorder([0, 1, 2, 3, 4, 5], [10], "reaction", "Node10rec.out")
Recorder.ElementRecorder([10001, 10002], "strains", "ElementStrains.out")
Recorder.ElementRecorder([10001, 10002], "stresses", "ElementStresses.out")
...
ImposedMotion(10, 2, MultipleSupportPattern, TheGM)
