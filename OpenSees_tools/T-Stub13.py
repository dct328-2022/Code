...
uniaxialMaterial.Steel01(1, 275, 205000, 0.01)
...
# Shear Area is A/k
uniaxialMaterial.Elastic(5, 205000/(2*(1+0.3))*5/6*12.5*190)
uniaxialMaterial.Elastic(6, 205000/(2*(1+0.3))*9/10*3.1415926*6*6)

uniaxialMaterial.Steel01(7, 1090, 205000, 0.01)

# Flange Section
Patch1 = RectPatch(1, 10, 10, -6.25, -95, 6.25, 95)
...
'''LineElement.ForceBeamColumn(1, 11, 12, 1, 10, Int2, Sec2)
LineElement.ElasticBeamColumn(2, 12, 13, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)
LineElement.ElasticBeamColumn(3, 13, 14, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)
LineElement.ElasticBeamColumn(4, 14, 15, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)
LineElement.ElasticBeamColumn(5, 12, 16, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)
LineElement.ElasticBeamColumn(6, 16, 17, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)
LineElement.ElasticBeamColumn(7, 17, 18, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)

LineElement.ForceBeamColumn(8, 21, 22, 1, 10, Int2, Sec2)
LineElement.ElasticBeamColumn(9, 22, 23, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)
LineElement.ElasticBeamColumn(10, 23, 24, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)
LineElement.ElasticBeamColumn(11, 24, 25, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)
LineElement.ElasticBeamColumn(12, 22, 26, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)
LineElement.ElasticBeamColumn(13, 26, 27, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)
LineElement.ElasticBeamColumn(14, 27, 28, 160.5, 204105, 79568, 3500.0, 1531.30375, 1531.30375, 1)'''
...
double M1;
   ...
   do {
      ...
      res2 = (ElasticBeamColumn16->getResistingForce())(11);
      opserr << "h2 " << h2 << "\n";
      opserr << "r2 " << r2 << "\n";
      opserr << "M2 " << M2 << "\n";
      opserr << "V2 " << V2 << "\n";
      ...
      res1 = (ElasticBeamColumn15->getResistingForce())(11);
      opserr << "h1 " << h1 << "\n";
      opserr << "r1 " << r1 << "\n";
      opserr << "M1 " << M1 << "\n";
      opserr << "V1 " << V1 << "\n";
...
'''double M1;
   ...
   do {
      ...
      res2 = (ElasticBeamColumn4->getResistingForce())(11);
      opserr << "h2 " << h2 << "\n";
      opserr << "r2 " << r2 << "\n";
      opserr << "M2 " << M2 << "\n";
      opserr << "V2 " << V2 << "\n";
      ...
      res1 = (ElasticBeamColumn3->getResistingForce())(11);
      opserr << "h1 " << h1 << "\n";
      opserr << "r1 " << r1 << "\n";
      opserr << "M1 " << M1 << "\n";
      opserr << "V1 " << V1 << "\n";
...
'''double M1;
    ...
    do {
        ...
        r2 = (node12->getDisp())(5) - (node17->getDisp())(5);
        opserr << "r2 " << r2 << "\n";
        M2 = (ElasticTimoshenkoBeam2->getResistingForce())(5);
        opserr << "M2 " << M2 << "\n";
        V2 = (ElasticTimoshenkoBeam2->getResistingForce())(1);
        opserr << "V2 " << V2 << "\n";
        ...
        r1 = (node12->getDisp())(5) - (node17->getDisp())(5);
        opserr << "r1 " << r1 << "\n";
        M1 = -(ElasticTimoshenkoBeam1->getResistingForce())(5);
        opserr << "M1 " << M1 << "\n";
        V1 = (ElasticTimoshenkoBeam1->getResistingForce())(1);
        opserr << "V1 " << V1 << "\n";
...
WriteCpp('/home/chenting/Chenting/TestExp/OpenSees/EXAMPLES/T-Stub/T-Stub13/main.cpp').WriteCommands()
